...
<div class="mp_wrapper">
  ...
  <form class="mepr-account-form mepr-form" id="mepr_account_form" action="" method="post" novalidate>
    ...
    <?php endif; ?>
    <div class="mp-form-row mepr_email" style="display:none;">
      <div class="mp-form-label">
    ...
    <input type="submit" name="mepr-account-form" value="<?php _ex('Save Billing Details', 'ui', 'memberpress'); ?>" class="mepr-submit mepr-share-button" />
