		...
		<table id="latest" class="table table-borderless">
			<thead>
				<tr>
					...
					if( $tag_id == 72 || $tag_id == 73 ) : // casual || intern ?> <th scope="col">Pay</th> <?php else : ?> <th scope="col">Salary</th> <?php endif; ?>
				</tr>
			</thead>
